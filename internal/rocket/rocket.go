...
// Rocket - should contains the definition of
// our rocket
type Rocket struct {
	ID      string
	Name    string
...
// Service - our rocket service, responsible
// for updating the rocket inventory
type Service struct {
	Store Store
}

// NewRocket - returns a new instance of
// our rocket service
func NewRocket(store Store) *Service {
	return &Service{
		Store: store,
	}
}

// GetRocketByID - retrieves a rocket based
// on the ID from the store
...
// InsertRocket - inserts a new rocket into
// the store.
...
// DeleteRocket - deletes a rocket from
// our inventory
